    ...
    <section class="feedback container">
        ...
        <div class="feedback-cards">
          ...
          <article class="feedback-card feedback-card-pink">
            <h4>NIDDA ALPI'AH</h4>
            <p>many web sites still in their infancy.</p>
  ...
  <footer class="footer container">
    ...
    <div class="footer-top">
      <div class="footer-logo-desc">
        ...
        <p>Kesehatan adalah harta paling berharga yang sering kita abaikan. Website ini hadir sebagai sahabat kesehatan Anda—menyediakan informasi lengkap, dan layanan yang memudahkan Anda untuk hidup lebih sehat dan bahagia. Karena Anda dan orang-orang tercinta layak mendapatkan perhatian dan perawatan terbaik</p>
      </div>
